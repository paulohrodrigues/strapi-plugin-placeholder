import require$$1 from "mime-types";
import require$$0$1 from "yup";
import require$$0$2 from "plaiceholder";
...
const { getPlaiceholder } = require$$0$2;
